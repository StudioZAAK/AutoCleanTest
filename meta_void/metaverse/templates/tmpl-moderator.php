<script type="text/html" id="mod_tmpl">
    <div class="user-block" id="a{{uid}}">
        ...
        <div class="button-speaker">
            ...
            <!-- This setting for Admin only -->
            <button id="kickUser" class="button grau" onclick="KickUser('{{uid}}')">
                <img src="<?php echo get_template_directory_uri(); ?>/metaverse/svg/kick.svg" alt="Toggle Voice Chat">
            </button>
        </div>
