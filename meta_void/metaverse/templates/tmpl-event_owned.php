<script type="text/html" id="event_owner_tmpl">
        ...
        <div class="text">
            <div class="header-details">
                ...
                <div>
                    ...
                    <button class="button-icon" id="detailDelete" onclick="ToggleTryDelete('{{uid}}',true)"><img src="<?php echo get_template_directory_uri(); ?>/metaverse/images/delete.svg"></button>
                    <button class="button-icon" id="detailEdit" onclick="OpenEditEvent('{{uid}}')"><img src="<?php echo get_template_directory_uri(); ?>/metaverse/images/edit.svg"></button>
            ...
            <div class="deletion-note" style="display:none;">
                <div> Do you want to delete this event?</div>
                <button onclick="DeleteEvent('{{uid}}')">Yes</button>
                <button onclick="ToggleTryDelete('{{uid}}', false)">No</button>
                <div></div>
            </div>
